                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        <?php
                          ...
                          $query=mysqli_query($conn,"select * from employee ORDER BY emp_id asc")or die(mysqli_error($query));
                        ...
                        <tr>
                          <td align="center"><a href="view_employee.php?emp_id=<?php echo $row["emp_id"]; ?>" title="Update"><?php echo $row['fname'] ?>  <?php echo $row['lname'] ?></a></td>
