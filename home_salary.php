          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
                ...
                <button type="button" data-toggle="modal" data-target="#salary" class="btn btn-primary">Modify Bonous for all employes</button>
                <p class="pull-right">Overtime rate per hour: <big><b><?php echo $rate; ?>.00</b></big></p><br>
                <p class="pull-right">BONOUS FOR ALL EMPLOYES: <big><b><?php echo $salary; ?>.00</b></big></p>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($row=mysqli_fetch_array($query))
                          {
                            ...
                            $salary1    = $row['salaray'];
                            $deduction  = $row['deduction'];
                            $income   = $over + $bonus + $salary1 + $salary_rate;
                        ...
                        <tr>
                          ...
                          <td align="center"><big><b><?php echo $salary1?></b></big>.00</td>
      ...
      <div class="modal fade" id="salary" role="dialog">
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            <div class="modal-header" style="padding:20px 50px;">
              <button type="button" class="close" data-dismiss="modal" title="Close">&times;</button>
              <h3 align="center">Enter the amount of <big><b>Bonus</b></big> for all employees</h3>
            </div>
            <div class="modal-body" style="padding:40px 50px;">
