    ...
    <div class="container">
      ...
      <?php
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
            ...
            $salary1 = $row['salaray'];
            $income   = $overtime + $bonus + $salary1 + $salary;
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $none1; ?>">None</option>
                      <option value="<?php echo $phil; ?>">Health Insurance</option>
                      <option value="<?php echo $bir; ?>">Sodexo</option>
                      <option value="<?php echo $gsis; ?>">NPS</option>
                      <option value="<?php echo $love; ?>">Stock</option>
                  ...
                  <div class="form-group">
                  <label class="col-sm-5 control-label">Salaray Rate  :</label>
                    <div class="col-sm-4">
                      <input type="text" name="salaray" class="form-control" value="<?php echo $row['salaray'];?>" required="required">
                    </div>
                  </div><br><br>
